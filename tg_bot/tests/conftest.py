...
def sample_kafka_message():
    ...
    return {"action": "INSERT", "table": "promo_category", "data": {"name": "Тестовая категория", "id": 1}}
...
def sample_kafka_message_update():
    ...
    return {
        "action": "UPDATE",
        "table": "promo_offer",
        "data": {"title": "Новое название", "id": 1},
        "dataOld": {"title": "Старое название", "id": 1},
    }
...
def sample_kafka_message_delete():
    ...
    return {"action": "DELETE", "table": "promo_city", "data": {"name": "Удаленный город", "id": 1}}
